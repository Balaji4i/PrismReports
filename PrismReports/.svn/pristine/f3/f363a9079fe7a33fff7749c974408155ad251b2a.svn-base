--------------------------------------------------------
--  DDL for View XXFND_LOOKUP_V
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE VIEW "XXFND_LOOKUP_V" ("LOOKUP_TYPE_ID", "LOOKUP_TYPE_NAME", "LOOKUP_TYPE_NAME_DISP", "LOOKUP_TYPE_NAME_DISP_TL", "LT_ACCESS_LEVEL", "LT_ACTIVE_YN", "LOOKUP_VALUE_ID", "LOOKUP_VALUE_NAME", "LOOKUP_VALUE_NAME_DISP", "LOOKUP_VALUE_NAME_DISP_TL", "LOOKUP_ADDL_VALUE", "LV_ACCESS_LEVEL", "LV_ACTIVE_YN", "DISPLAY_ORDER") AS SELECT lt.lookup_type_id
         ,lt.lookup_type_name
         ...
         ,lv.active_yn
         ,lv.display_order
     FROM xxfnd_lookup_types lt, xxfnd_lookup_values lv
    WHERE     lt.lookup_type_id =   lv.lookup_type_id
           AND lt.lookup_type_id =   lt.lookup_type_id
                                  + 0
          AND lv.lookup_type_id =   lv.lookup_type_id
                                   + 0
