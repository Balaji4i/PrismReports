...
--------------------------------------------------------
  ...
  SELECT DISTINCT
        ...
        bc.attribute20,
        bc.created_by,
        trunc(bc.creation_date) creation_date,
        bc.last_updated_by,
        trunc(bc.last_update_date) last_update_date,
