...
p_unit_id number;
begin
SELECT UNIT_ID into cp_unit_id FROM XXPM_PROPERTY_UNITS where UNIT_NUMBER = cp_number;
SELECT UNIT_ID into p_unit_id FROM xxpm_booking_detail where booking_hdr_id=p_booking_hdr_id;
