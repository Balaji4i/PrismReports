...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_REGISTRATION_PCS_V" ("REGN_ID", "FUNC_ID", "REGN_NUMBER", "REGN_DATE", "BOOKING_HDR_ID", "BOOKING_AMOUNT", "BOOKING_NUMBER", "PROPERTY_NAME", "CUSTOMER_NAME", "INVOICED_AMOUNT", "RECEIPT_AMOUNT", "APPLIED_RECEIPT_AMOUNT", "TOTAL_AMOUNT", "JOINT_OWNER", "PROPERTY_ID", "ORG_ID") AS 
  SELECT
        xr.regn_id,
        xr.func_id,
        xr.regn_number,
