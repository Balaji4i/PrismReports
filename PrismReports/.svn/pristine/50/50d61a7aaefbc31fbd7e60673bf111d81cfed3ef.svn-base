...
--------------------------------------------------------
--  DDL for Package Body XXPM_UNIT_MASTER_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "XXPM_UNIT_MASTER_PKG" 
AS
PROCEDURE xxpm_unit_master_val (i_batch_id IN NUMBER)
AS
cursor c_unit_temp
...
l_unit_id                                --        unit_id
            ...
            SET            INTERFACE_STATUS_FLAG='P',
                           ...
                           ERR_MSG=null
            where   property_number=i.property_number and build_number=i.build_number and
