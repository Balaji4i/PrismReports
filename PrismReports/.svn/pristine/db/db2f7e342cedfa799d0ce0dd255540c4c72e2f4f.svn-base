...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_BILLING_BOOKING_V" ("INSTALLMENT_EVENT", "STATUS", "BOOKING_MS_DTL_ID", "BILLING_ID", "MILESTONE_TYPE", "INSTALLMENT_TYPE", "INSTALLMENT_DISP_NAME", "CHARGE_TYPE", "DUE_DATE", "INSTALLMENT_AMOUNT", "RATE", "BOOKING_HDR_ID", "BOOKING_NUMBER", "PROPERTY_ID", "ORG_ID", "CUST_BOOKING_HDR_ID", "CUST_ID", "CUSTOMER_NAME", "ORG_NAME", "PROPERTY_NAME", "OFFER_HDR_ID", "OFFER_NUMBER", "UNIT_NUMBER", "UNIT_NAME", "USAGE") AS 
  select distinct
...
AND XBM.INVOICE_ID IS NULL
--IF Cancelled remaining Ms no billing
and XBM.MILESTONES_STATUS IS NULL
