...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_MILESTONE_HEADER_PCS_V" ("MS_HDR_ID", "PAYMENT_PLAN_SHORT_CODE", "REVISION_NO", "REVISED_BY", "REVISION_DATE", "BUSINESS_UNIT", "START_DATE", "END_DATE", "PAYMENT_PLAN_DATE", "DESCRIPTION") AS 
  SELECT DISTINCT
        hdr.ms_hdr_id,
        hdr.milestone_name,
        hdr.revision_no,
