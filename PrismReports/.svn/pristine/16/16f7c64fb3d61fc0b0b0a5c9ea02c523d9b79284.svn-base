--------------------------------------------------------
--  DDL for Package Body XXDM_SALE_RECEIPTS_OPEN_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "XXDM_SALE_RECEIPTS_OPEN_PKG" 
AS
  PROCEDURE sales_receiptso_val(
  ...
  BEGIN
    ...
    END LOOP;
    COMMIT;
  END sales_receiptso_val;
  PROCEDURE sales_receiptso_insert(
      P_ERR_CODE OUT VARCHAR2,
      P_ERR_MSG OUT VARCHAR2)
  AS
        ...
        BEGIN
          ...
          INTO xxpm_receipt
            ...
            (
              ...
              i.BANK_BRANCH_NAME ,       --        bank_branch_name,
              NULL,                      --        drawn_by,
              i.STATUS,                  --        status,
              NULL,                      --        description,
              NULL,                      --        flow_status,
