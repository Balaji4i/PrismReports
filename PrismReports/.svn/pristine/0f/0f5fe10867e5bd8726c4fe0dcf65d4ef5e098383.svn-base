create or replace PROCEDURE XXPM_OFFER_MILESTONE_DETAIL_SERVICE(
...
BEGIN
  ...
  SELECT XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).OFFER_MS_DTL_ID INTO p_offer_milestone_id FROM DUAL;
    ...
    (SELECT 
	  ...
	  XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).INCLUDED_IN_RATE    INCLUDED_IN_RATE   ,  
	  XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).TAX_RATE     		TAX_RATE    		,
	  XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).TAX_CODE     		TAX_CODE    		,
	  XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).TAX_AMOUNT     		TAX_AMOUNT    		,
	  XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).CARPARKING			CARPARKING			,
	  XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).OTHER_CHARGE_TYPE 	OTHER_CHARGE_TYPE
  ...
  WHEN MATCHED THEN
    ...
    SET OFFER_HDR_ID       = b.OFFER_HDR_ID        ,
	  ...
	  INCLUDED_IN_RATE 	 = b.INCLUDED_IN_RATE  	,
	  TAX_RATE     	     = b.TAX_RATE     		,	
	  TAX_CODE     	     = b.TAX_CODE     		,
	  TAX_AMOUNT     	 = b.TAX_AMOUNT     	,	
	  CARPARKING		 = b.CARPARKING			,
	  OTHER_CHARGE_TYPE  = b.OTHER_CHARGE_TYPE	
    ...
    INSERT
      ...
      (
		...
		XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).INCLUDED_IN_RATE    ,
		XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).TAX_RATE      	  ,
		XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).TAX_CODE   		   ,
		XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).TAX_AMOUNT   		   ,
		XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).CARPARKING   		   ,
		XXPM_OFFER_MILESTONE_DETAIL_TYPE_T(i).OTHER_CHARGE_TYPE   	
      );
    COMMIT;
