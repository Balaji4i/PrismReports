...
WHERE
 ...
 --==============================================================================
    ...
    ---------------------unit Validations----------------------------------
    --==============================================================================
    l_unit_id       :=xxpm_dm_lib_pkg.get_unit_id(i.UNIT_SHORT_CODE,i.building ,i.property,i.business_unit);
...
FROM
 ...
 update XXPM_BOOKING_MILESTONES set INVOICE_ID = l_invoice_id where booking_hdr_id= i.booking_id;
