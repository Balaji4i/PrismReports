...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_BLOCKING_DETAILS_PCS_V" ("BLOCK_DTL_ID", "BLOCK_ID", "PROPERTY_ID", "PROPERTY_NAME", "PROPERTY_NAME_TL", "BUILD_ID", "BUILD_NAME", "BUILD_NUMBER", "UNIT_ID", "UNIT_NAME", "UNIT_NUMBER", "UNIT_TYPE", "AREASQ", "UOM", "QUANTITY", "BASE_RATE", "OFFER_AMOUNT", "DISC_PCT", "DISC_AMOUNT", "TAX_CODE", "TAX_RATE", "TAX_AMOUNT", "MOD_NAME", "UNIT_CATEGORY", "CATEGORY_NAME", "UNIT_TYPE_NAME", "UOM_NAME") AS 
  SELECT
        xbd.block_dtl_id,
        xbd.block_id,
        xbd.property_id,
