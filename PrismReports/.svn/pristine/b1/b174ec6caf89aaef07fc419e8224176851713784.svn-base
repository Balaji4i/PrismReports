  ...
  CREATE OR REPLACE FORCE  VIEW "APPLY_CREDIT_MEMO_REFUND_V" ("BOOKING_ID", "CREDITMEMOTRXNUMBER", "AMOUNTAPPLIED", "APPLYDATE", "GLDATE", "ORG_ID", "CREDITMEMOBUSINESSUNIT", "REFUNDPAYMENTMETHODNAME") AS 
  with
inv_number as (
SELECT
inv.INVOICE_NUMBER,
