...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_AREA_CHANGE_LINE_PCS_V" ("AREA_CNG_DLT_ID", "AREA_CNG_HDR_ID", "PROPERTY_NAME", "BUILD_NAME", "UNIT_NAME", "UNIT_CATEGORY", "BOOKING_NUMBER", "STATUS", "UOM", "OLD_AREA_VALUE", "NEW_AREA_VALUE", "DESCRIPTION", "ADJ_BOOKING_AMOUNT", "SPA_PCT", "AREA_EXCEED_TOLERANCE", "CUST_ACCEPTED_YN") AS 
  SELECT
        xd.area_cng_dlt_id,
        xd.area_cng_hdr_id,
        xp.property_name,
