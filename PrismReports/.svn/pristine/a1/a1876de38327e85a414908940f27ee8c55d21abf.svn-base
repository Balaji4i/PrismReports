...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_BOOKING_MILESTONES_PCS_V" ("ROW_ID", "BOOKING_HDR_ID", "BOOKING_MS_DTL_ID", "MILESTONE_TYPE", "MS_DTL_ID", "PL_MOD_ID", "SEQ_NUMBER", "INSTALLMENT_TYPE", "INSTALLMENT_TYPE_DESC", "INSTALLMENT_PCT", "INSTALLMENT_AMOUNT", "UOM", "QUANTITY", "RATE", "WAVE_OFF", "INCLUDED_IN_RATE", "INSTALLMENT_METHOD", "INSTALLMENT_METHOD_DESC", "INSTALLMENT_EVENT", "PERIOD_OCCURENCE", "PERIOD_VALUES", "PERIOD_DURATION", "CHARGE_TYPE", "CHARGE_TYPE_DESC", "PAYMENT_TERM", "REMARKS", "DUE_DAYS", "DUE_DAYS_FROM", "DUE_DATE", "ATTRIBUTE_CATEGORY", "ATTRIBUTE1", "ATTRIBUTE2", "ATTRIBUTE3", "ATTRIBUTE4", "ATTRIBUTE5", "ATTRIBUTE6", "ATTRIBUTE7", "ATTRIBUTE8", "ATTRIBUTE9", "ATTRIBUTE10", "CREATED_BY", "CREATION_DATE", "LAST_UPDATED_BY", "LAST_UPDATE_DATE", "LAST_UPDATE_LOGIN", "SOURCE_FUNC_ID", "SOURCE_FUNC_REF_ID", "BILLING_ID", "STATUS", "INVOICE_ID") AS 
  SELECT DISTINCT
        xbm.rowid,
        xbm.booking_hdr_id,
