...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_BLOCK_MILESTONE_DETAIL_PCS_V" ("OFFER_MS_DTL_ID", "OFFER_HDR_ID", "MS_DTL_ID", "PL_MOD_ID", "SEQ_NUMBER", "INSTALLMENT_TYPE", "INSTALLMENT_TYPE_DISP", "INSTALLMENT_PCT", "INSTALLMENT_AMOUNT", "CHARGE_TYPE", "CHARGE_TYPE_DISP", "PAYMENT_TERM", "PAYMENT_TERM_DISP", "REMARKS", "DUE_DAYS", "DUE_DAYS_FROM", "DUE_DATE", "CREATED_BY", "CREATION_DATE", "LAST_UPDATED_BY", "LAST_UPDATE_DATE", "LAST_UPDATE_LOGIN", "MILESTONE_TYPE", "UOM", "QUANTITY", "RATE", "WAVE_OFF", "INSTALLMENT_METHOD", "INSTALLMENT_EVENT", "PERIOD_OCCURENCE", "PERIOD_VALUES", "PERIOD_DURATION", "INCLUDED_IN_RATE") AS 
  SELECT
        bms.offer_ms_dtl_id,
        bms.offer_hdr_id,
        bms.ms_dtl_id,
