...
BASEAMOUNT          =xxpm_bill_invoice_pkg.GET_LINE_AMT(i.installment_amount_r,l_TAX_CODE, NVL(l_TAX_RATE,0)),
TAX_AMOUNT          =xxpm_bill_invoice_pkg.GET_TAX_AMT(i.installment_amount_r,l_TAX_CODE, NVL(l_TAX_RATE,0)),
TAX_CODE=l_TAX_CODE, 
TAX_RATE=l_TAX_RATE
        ...
        IF(i.action_flag = 'NEW') THEN
          ...
          INTO xxpm_booking_milestones
            ...
            (
              ...
              l_TAX_RATE, 
              l_TAX_CODE, 
              xxpm_bill_invoice_pkg.GET_TAX_AMT(i.installment_amount_r,l_TAX_CODE, NVL(l_TAX_RATE,0)),
              xxpm_bill_invoice_pkg.GET_LINE_AMT(i.installment_amount_r,l_TAX_CODE, NVL(l_TAX_RATE,0))
            );
