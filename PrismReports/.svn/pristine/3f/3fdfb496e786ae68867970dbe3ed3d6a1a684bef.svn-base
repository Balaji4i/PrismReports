...
WHERE     bhr.booking_hdr_id = bkl.booking_id(+)
      ...
      and bhr.booking_hdr_id=bhr.booking_hdr_id+0
       and bmsuniv.booking_hdr_id=bmsuniv.booking_hdr_id+0
       and receamt.booking_id=receamt.booking_id+0
