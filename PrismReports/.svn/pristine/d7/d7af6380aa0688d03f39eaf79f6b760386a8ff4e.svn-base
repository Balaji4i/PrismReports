...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_INVOICE_V" ("INVOICE_ID", "INVOICE_NUMBER", "ORG_ID", "ORGANIZATION_NAME", "CUST_ID", "CUSTOMER_NAME", "BOOKING_NUMBER", "OFFER_NUMBER", "PROPERTY_ID", "PROPERTY_NUMBER", "PROPERTY_NAME", "BUILD_ID", "BUILD_NUMBER", "BUILD_NAME", "UNIT_ID", "UNIT_NUMBER", "UNIT_NAME", "INVOICE_DATE", "INVOICE_STATUS", "CHARGE_TYPE", "TRX_SOURCE", "TRX_TYPE", "CURRENCY_CODE", "PAYMENT_TERMS", "STATUS", "CUSTOMER_TRX_NUMBER", "RULE_START_DATE", "RULE_END_DATE", "ACNT_RULE", "INVOICING_RULE", "CREATED_BY") AS 
  SELECT
        xh.invoice_id,
        xh.invoice_number,
        xh.org_id,
