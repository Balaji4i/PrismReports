...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_MILESTONE_PCS_V" ("S_NO", "MS_HDR_ID", "PAYMENT_PLAN", "PAYMENT_PLAN_SHORT_CODE", "REVISION_NO", "REVISED_BY", "REVISION_DATE", "BUSINESS_UNIT", "START_DATE", "END_DATE", "PAYMENT_PLAN_DATE", "DESCRIPTION", "INSTALLMENT_TYPE", "INSTALLMENT_PERCENTAGE", "CHARGE_TYPE", "PAYMENT_TERM", "INSTALLMENT_METHOD", "INSTALLMENT_EVENT", "PROJ_MS_ID", "PROJECT_START_DATE", "PROJECT_END_DATE", "PERIOD_OCCURANCE", "PERIOD_DURATION", "PERIOD_VALUES", "DUE_DAYS", "DUE_DATE", "REMARKS") AS 
  SELECT DISTINCT
        ROWNUM,
        hdr.ms_hdr_id,
        hdr.milestone_name,
