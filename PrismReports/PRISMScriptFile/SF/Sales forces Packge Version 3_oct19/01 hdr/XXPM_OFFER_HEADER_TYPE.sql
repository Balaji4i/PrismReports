create or replace type "XXPM_OFFER_HEADER_TYPE" AS TABLE OF XXPM_OFFER_HEADER_TYP;
/
create or replace TYPE xxpm_offer_header_typ AS OBJECT (
    offer_hdr_id             NUMBER,
    org_id                   NUMBER,
    func_id                  NUMBER,
