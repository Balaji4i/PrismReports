...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_BOOKING_MOVE_V" ("BOOKING_DTL_ID", "BOOKING_HDR_ID", "BOOKING_NUMBER", "ORG_ID", "ORG_NAME", "USAGE", "STATUS", "PROPERTY_ID", "PROPERTY_NAME", "BUILDING_ID", "BUILD_NAME", "UNIT_ID", "UNIT_NAME", "UNIT_CATEGORY", "UNIT_TYPE", "UNIT_TYPE_DESC", "CUST_ID", "CUSTOMER_NUMBER", "CUSTOMER_NAME", "SHIP_TO_SITE_ID", "SHIP_TO_SITE_NUMBER", "SHIP_TO_SITE_NAME", "BILL_TO_SITE_ID", "BILL_TO_SITE_NUMBER", "BILL_TO_SITE_NAME", "CUST_CONTACT_ID", "CONTACT_NAME", "PRIMARY_YN", "CREATED_BY", "CREATION_DATE", "LAST_UPDATED_BY", "LAST_UPDATE_DATE", "LAST_UPDATE_LOGIN", "BOOKING_FROM_DATE", "BOOKING_TO_DATE", "Line", "MS", "Fix", "Charge", "TOTOAL_SALE_VALUE", "INV_AMOUNT", "REC_AMOUNT") AS 
  SELECT
        dtl.booking_dtl_id,
        dtl.booking_hdr_id,
        hdr.booking_number,
