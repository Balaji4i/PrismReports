--------------------------------------------------------
--  DDL for Procedure XXSTG_SYNC_CUSTOMER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "XXSTG_SYNC_CUSTOMER" (
    p_xml_data   IN           CLOB,
...
BEGIN
    ...
    dbms_output.put_line ('--'||l_customer_tbl(i).last_update_date); 
