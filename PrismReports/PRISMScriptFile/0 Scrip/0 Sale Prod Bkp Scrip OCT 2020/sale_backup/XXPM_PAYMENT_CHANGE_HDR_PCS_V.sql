...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_PAYMENT_CHANGE_HDR_PCS_V" ("MS_REV_ID", "BOOKING_NUMBER", "ORG_ID", "ORG_NAME", "BOOKING_DATE", "PROPERTY_ID", "PROPERTY_NAME", "BOOKING_DTL_ID", "BOOKING_HDR_ID", "CUST_ID", "CUSTOMER_NAME", "PL_ID", "PL_NAME", "MS_HDR_ID", "MILESTONE_NAME", "BOOKING_AMOUNT") AS 
  SELECT
        xbmrh.ms_rev_id,
        xbh.booking_number,
        xbh.org_id,
