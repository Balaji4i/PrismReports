...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_CANCEL_HDR_PCS_V" ("CANCEL_ID", "BOOKING_HDR_ID", "CANCEL_NUMBER", "BOOKING_NUMBER", "CANCEL_DATE", "PROPERTY_NAME", "PROPERTY_ID", "CUSTOMER_NAME", "TOTAL_AMOUNT", "CLEARED_AMOUNT", "INVOICED_AMOUNT", "COLLECTED_AMOUNT", "FORFEIT_AMOUNT", "REFUND_AMOUNT") AS 
  SELECT
        cancel_id,
        booking_hdr_id,
        cancel_number,
