...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_RECEIPT_VXXPM_RECEIPT_V" ("ROW_ID", "RECEIPT_ID", "RECEIPT_NUMBER", "RECEIPT_DATE", "ORG_ID", "BUSINESS_UNIT", "RECEIPT_TYPE", "PROPERTY_ID", "PROPERY_NAME", "PROPERY_NUMBER", "UNIT_ID", "UNIT_NAME", "UNIT_NUMBER", "BUILD_ID", "BUILING_NAME", "BUILING_NUMBER", "LEAD_ID", "CUST_ID", "CUSTOMER_NAME", "CUST_SITE_ID", "SITE_NUMBER", "SALESMAN_ID", "CURRENCY_CODE", "RECEIPT_AMOUNT", "RECEIPT_METHOD_NAME", "PAY_MODE", "PAY_REF_NUMBER", "PAY_REF_DATE", "BANK_NAME", "BANK_BRANCH_NAME", "STATUS", "DESCRIPTION", "RECOMMENDED_AMOUNT", "RECEIVED_AMOUNT", "DIFF_IN_DAYS", "PAY_REC_DATE", "PAY_REV_DATE", "RCT_TYPE", "RCT_DESC") AS 
  SELECT
        xr.rowid,
        xr.receipt_id,
        xr.receipt_number,
