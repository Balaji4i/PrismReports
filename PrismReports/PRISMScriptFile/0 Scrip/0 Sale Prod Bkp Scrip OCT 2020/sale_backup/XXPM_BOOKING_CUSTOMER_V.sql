...
--------------------------------------------------------
  ...
  SELECT
    ...
    WHERE
        ...
        and oh.CUST_SITE_ID (+) =cs1.CUST_SITE_ID
        AND oh.CUST_SITE_ID (+) =cc.CUST_SITE_ID
        and oh.OFFER_HDR_ID(+)=xbh.OFFER_HDR_ID
