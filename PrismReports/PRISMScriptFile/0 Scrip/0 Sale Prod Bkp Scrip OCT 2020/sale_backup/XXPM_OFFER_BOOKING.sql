--------------------------------------------------------
--  DDL for Procedure XXPM_OFFER_BOOKING
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "XXPM_OFFER_BOOKING" (I_OFFER_HDR_ID   IN NUMBER,
    I_BOOK_TYPE      IN VARCHAR2,
    I_BOOKING_HDR_ID IN NUMBER,
    I_BOOKING_EXE_BY    IN VARCHAR2,
    ...
    LOOP
      ...
      INTO XXPM_BOOKING_DETAIL
        ...
        (
          ...
          i.QUANTITY,
          i.BASE_RATE,
--          (nvl(i.OFFER_AMOUNT,0)- nvl(i.DISC_AMOUNT, 0)+nvl(i.TAX_AMOUNT,0)),
          i.OFFER_AMOUNT,
          i.PL_MOD_ID,
          i.DISC_PCT,
          i.DISC_AMOUNT,
...
SELECT 
TAX_CODE, TAX_RATE
into l_tax_code, l_tax_rate 
FROM xxpm_offer_detail 
where 
1=1
and OFFER_HDR_ID=I_OFFER_HDR_ID;
--DBMS_OUTPUT.PUT_LINE('l_tax_code = ' || l_tax_code);
--DBMS_OUTPUT.PUT_LINE('l_tax_rate = ' || l_tax_rate);
--DBMS_OUTPUT.PUT_LINE('V_OFFER_HDR_ID = ' || V_OFFER_HDR_ID);
      ...
      INTO XXPM_BOOKING_MILESTONES
        ...
        (
          ...
          ,round(nvl((i.INSTALLMENT_AMOUNT/(100+l_tax_rate))*100,0),2),
          l_tax_rate,
          l_tax_code,
          round(nvl((i.INSTALLMENT_AMOUNT/(100+l_tax_rate))*l_tax_rate,0),2)
        );
    END LOOP;
