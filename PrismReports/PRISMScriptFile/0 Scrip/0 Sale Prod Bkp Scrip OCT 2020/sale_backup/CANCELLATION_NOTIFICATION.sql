--------------------------------------------------------
--  DDL for Procedure CANCELLATION_NOTIFICATION
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "CANCELLATION_NOTIFICATION" (
                        P_VALUE          IN           VARCHAR2,
...
l_DESCRIPTION  VARCHAR2(240):='No Remarks';
...
ATTRIBUTE3:=l_cancel_date;
ATTRIBUTE4:=l_CREATED_BY;
ATTRIBUTE5:=NVL(l_status_display,'NILL');
ATTRIBUTE6:=NVL(l_DESCRIPTION, 'No Remarks');
else
...
--'cancellation.prism@omniyat.com';
--'ibrahim.hb@4iapps.com';
--l_CREATED_BY;
