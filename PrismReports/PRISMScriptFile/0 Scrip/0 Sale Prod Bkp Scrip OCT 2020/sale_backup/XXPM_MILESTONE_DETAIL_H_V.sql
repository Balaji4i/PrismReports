...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "XXPM_MILESTONE_DETAIL_H_V" ("MS_DTL_ID_H", "MS_DTL_ID", "MS_HDR_ID", "SEQ_NUMBER", "INSTALLMENT_TYPE_CODE", "INSTALLMENT_TYPE", "INSTALLMENT_PCT", "CHARGE_TYPE", "TERM_NAME", "INSTALLMENT_METHOD", "INSTALLMENT_EVENT", "PROJ_MS_ID", "PROJECT_START_DATE", "COMPLETION_DATE", "PERIOD_OCCURENCE", "PERIOD_DURATION", "PERIOD_VALUES", "DUE_DAYS", "DUE_DATE", "REMARKS", "CREATED_BY", "CREATION_DATE", "LAST_UPDATED_BY", "LAST_UPDATE_DATE", "LAST_UPDATE_LOGIN", "REVISION", "REVISION_DATE", "REVISED_BY") AS 
  SELECT
        dtl.ms_dtl_id_h,
        dtl.ms_dtl_id,
        dtl.ms_hdr_id,
