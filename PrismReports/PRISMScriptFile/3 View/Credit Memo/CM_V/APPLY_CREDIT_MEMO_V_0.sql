  CREATE OR REPLACE FORCE EDITIONABLE VIEW "XXPM_TEST"."APPLY_CREDIT_MEMO_V" ("BOOKING_ID", "ORG_ID", "ORG_NAME", "INVOICE_ID", "CREDIT_MEMO_TRX_NUMBER", "INVOICE_NUMBER", "APPLYDATE", "GLDATE", "INV_AMT", "APPLIED_RECEIPT_AMOUNT", "BALANCE") AS 
  WITH
cmc_inv
    as(
            SELECT
